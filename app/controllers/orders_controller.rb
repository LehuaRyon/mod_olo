class OrdersController < ApplicationController
    ...
    def order_params
        params.require(:order).permit(:pickup_name, :special_instructions, :pizza_id, pizza_attributes: [:name, :ingredients, :size], :search)  #, pizza_attributes: [:name, :ingredients, :size])
    end
